            ...
            <div className="h-screen flex items-center justify-center">
                <div className="">
                    ...
                    <div className="flex gap-x-8">
                        <button onClick={() => {signIn('google')}} className="flex gap-2 border border-blue rounded-lg px-16 py-4">
                        ...
                        <button className="flex gap-2 border border-blue rounded-lg px-16 py-4">
