...
import MyToast, { notifySuccess, notifyError, notifyInfo, notifyWarning, clearToasts } from '../components/toast/MyToast';
                ...
                <div className="">
                    ...
                    <div className="text-center">
                        ...
                        <div className="flex items-center justify-center">
                            <button onClick={() => signIn('google', { callbackUrl: '/details' })} className="flex gap-x-2 text-xs items-center justify-center border w-4/5 border-blueTheme rounded-lg px-4 md:px-16 py-3">
