...
export default function Login() {
    ...
    async function oauthLogin() {
        ...
        const response = await signIn('google', {callbackUrl: '/details'});
        if(response?.error) {
            alert("error")
        } else {
            console.log("response")
                ...
                <div className="">
                    ...
                    <div className="text-center">
                        ...
                        <div className="flex items-center justify-center">
                            <button onClick={oauthLogin} className="flex gap-x-2 text-xs items-center justify-center border w-4/5 border-blueTheme rounded-lg px-4 md:px-16 py-3">
