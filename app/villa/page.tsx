    ...
    <div>
      ...
      <div className="grid grid-cols-2 max-w-2xl my-16 mx-auto">
        <Link href={'/properties'}>
          <button type="button" className="focus:outline-none text-blue bg-transparent hover:bg-transparent ring-1 ring-blue font-medium rounded-xl text-3xl px-8 py-4 mb-2">Retail Properties</button>
        </Link>
        <Link href={'/villa'}>
          <button type="button" className="focus:outline-none text-white  bg-green  font-medium rounded-xl text-3xl px-8 py-4 mb-2">Villa Properties</button>
        </Link>
      </div>
