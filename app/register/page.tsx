    ...
    return (
        <div className="grid grid-cols-2 h-screen">
            <div className="h-screen flex items-center justify-center">
                <div className="">
                    <h2 className="font-bold text-4xl tracking-tigher mb-2">Register to your Account</h2>
                    ...
                    <form className="max-w-sm mx-auto">
                        ...
                        <div className="mb-5">
                            <input type="password" id="password" className="bg-gray-50 border-2 border-blueTheme text-gray-900 text-sm rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full px-2.5 py-4" placeholder="Confirm Password" required />
                        </div>
