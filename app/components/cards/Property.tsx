                    ...
                    <div className="text-center">
                        ...
                        <div className="bg-white border border-blueTheme rounded-lg m-4 grid grid-cols-2 gap-0">
                            <div className="flex justify-between m-3">
                                ...
                                <Typography className="text-blueTheme font-bold mt-1">{area}</Typography>
                            </div>
                            <div className="flex justify-between m-3">
                                ...
                                <Typography className="text-blueTheme font-bold mt-1">{yeild}</Typography>
                            </div>
                            <div className="flex justify-between m-3">
                                ...
                                <Typography className="text-blueTheme font-bold mt-1">{price}</Typography>
                            </div>
                            <div className="flex justify-between m-3">
                                ...
                                <Typography className="text-blueTheme font-bold mt-1 break-all">{returntarget}</Typography>
                            </div>
                        </div>
