...
export default function Villa() {
    return (
        ...
        <div className="max-w-sm p-2 mt-10 bg-card border-2 border-green rounded-lg shadow">
            <div className="m-2">
            ...
            <div className="text-center">
                ...
                <div className="bg-white border border-green rounded-lg m-4 grid grid-cols-2 gap-0">
                        <div className="flex justify-between m-3">
                            ...
                            <Typography className="text-green font-bold mt-1">15.9%</Typography>
                        </div>
                        <div className="flex justify-between m-3">
                ...
                <button type="button" className="focus:outline-none text-white hover:text-green bg-green hover:bg-transparent hover:ring-1 hover:ring-green font-medium rounded-xl text-sm px-10 py-3 mb-2 ">View Opportunity</button>
